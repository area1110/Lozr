...
public class CheckCookieFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("CheckCookieFilter:DoBeforeProcessing");
        }
...
//            t.printStackTrace();
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("CheckCookieFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("CheckCookieFilter()");
        }
        StringBuffer sb = new StringBuffer("CheckCookieFilter(");
